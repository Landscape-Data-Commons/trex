...
Very large requests with multiple MLRAs may overload the API server. In order to prevent this, the function will insert a delay between queries. This is defined in milliseconds, and defaults to 500ms. Like timeout, this is unlikely to ever need to be changed.
...
```{r}
error_data <- read.delim(file = "C:/Users/jrbrehm/Documents/Demo/unparsable_data_042B_state narratives_2023-08-10.txt", sep = "\t", quote = "", header = FALSE)
head(error_data)

cleaned_data <- read.delim(file = "C:/Users/jrbrehm/Documents/Demo/unparsable_data_042B_state narratives_2023-08-10_cleaned.txt", sep = "\t", quote = "", header = FALSE)
head(cleaned_data)
